    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col" dir={direction}>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        className="w-full bg-slate-900/90 text-white border border-white/20 rounded-xl py-3 pr-11 pl-4 text-sm focus:outline-none focus:border-[var(--brand-orange)] min-h-12"
                      >
      ...
      <section className="py-10 md:py-16 px-4 container mx-auto max-w-6xl">
        <div className="text-center space-y-3 mb-8 md:mb-12">
          <span className="text-[var(--brand-orange)] font-bold text-xs uppercase tracking-widest bg-[var(--brand-orange)]/10 px-3 py-1 rounded-full border border-[var(--brand-orange)]/30">
            {t('advancedDesign')}
          </span>
          <h2 className="text-2xl md:text-3xl font-black text-[var(--brand-navy)]">{t('exploreMainSections')}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 bg-gradient-to-br from-[var(--brand-navy)] to-slate-900 text-white p-5 md:p-8 rounded-2xl md:rounded-3xl shadow-xl relative overflow-hidden flex flex-col justify-between group">
            <div className="absolute -left-10 -bottom-10 w-64 h-64 bg-[var(--brand-orange)]/20 rounded-full blur-3xl pointer-events-none"></div>
            <div className="relative z-10 space-y-4 max-w-md">
              <div className="w-12 h-12 bg-[var(--brand-orange)] rounded-2xl flex items-center justify-center text-white shadow-lg">
              ...
              <div>
                <Link href="/search?type=car">
                  <Button className="bg-[var(--brand-orange)] hover:bg-[var(--brand-orange-dark)] text-white font-bold px-6 py-3 rounded-xl text-xs flex items-center gap-2 shadow-lg shadow-[var(--brand-orange)]/40 cursor-pointer">
          ...
          <div className="bg-white border border-slate-200 p-5 md:p-8 rounded-2xl md:rounded-3xl shadow-xl flex flex-col justify-between group">
            <div className="space-y-4">
              <div className="w-12 h-12 bg-[var(--brand-navy)] rounded-2xl flex items-center justify-center text-white shadow-lg">
                <Building2 className="w-6 h-6 text-[var(--brand-orange)]" />
              </div>
              <h3 className="text-xl font-black text-[var(--brand-navy)]">{t('propertyTitle')}</h3>
              <p className="text-slate-600 text-xs sm:text-sm leading-relaxed">
                {t('propertyDescription')}
              </p>
              <div>
                <Link href="/search?type=property">
                  <Button className="bg-[var(--brand-navy)] hover:bg-[var(--brand-navy-hover)] text-white font-bold px-6 py-3 rounded-xl text-xs flex items-center gap-2 shadow-md cursor-pointer">
      ...
      <section className="py-10 md:py-16 px-4 container mx-auto max-w-6xl">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-7 md:mb-10 gap-4">
          <div>
            ...
            <h2 className="text-2xl md:text-3xl font-black text-[var(--brand-navy)] mt-2">{t('featuredListings')}</h2>
          </div>
          <Link href="/search">
            <Button variant="outline" className="w-full md:w-auto border-[var(--brand-navy)] text-[var(--brand-navy)] hover:bg-[var(--brand-navy)] hover:text-white font-bold rounded-xl text-xs">
          ...
          {activeListings.slice(0, 6).map((item) => item.type === 'car' ? (
            ...
            <article key={item.id} className="b2-card b2-touch-card shadow-md hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 flex flex-col group">
              <div className="relative h-48 sm:h-56 overflow-hidden">
                ...
                />
                <div className="absolute top-3 right-3 bg-[var(--brand-navy)]/90 backdrop-blur-md text-white text-xs font-bold px-3 py-1 rounded-full shadow">
                  {item.category}
                </div>
              </div>
              ...
              <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between space-y-4">
                <div className="space-y-2">
                  <div className="flex items-center text-slate-500 text-xs gap-1">
                    <MapPin className="w-3.5 h-3.5 text-[var(--brand-orange)]" />
                    <span>{item.city}</span>
                  </div>
                  <h3 className="text-base font-black text-[var(--brand-navy)] line-clamp-1">{item.title}</h3>
                ...
                <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
                  <div>
                    ...
                    <span className="text-lg font-black text-[var(--brand-orange)]">{item.pricePerUnit} درهم</span>
                  </div>
                  <div className="flex gap-2">
                    <Link href={getListingPath(item)}>
                      <Button className="b2-card-action bg-[var(--brand-navy)] hover:bg-[var(--brand-navy-hover)] text-white font-bold px-4 py-2.5 rounded-xl text-xs shadow-md cursor-pointer">
                        {t('demoDetails')}
                      </Button>
                    </Link>
                  </div>
      ...
      <section className="py-10 md:py-16 bg-slate-100 mt-6 md:mt-12 border-y border-slate-200">
        <div className="container mx-auto max-w-6xl px-4 space-y-8">
          <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-4">
            <div>
              <span className="text-[var(--brand-orange)] font-bold text-xs uppercase tracking-widest bg-[var(--brand-orange)]/10 px-3 py-1 rounded-full">{t('blogEyebrow')}</span>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-black text-[var(--brand-navy)] mt-2">{t('latestArticles')}</h2>
            </div>
            <Link href="/blog">
              <Button variant="outline" className="border-[var(--brand-navy)] text-[var(--brand-navy)] hover:bg-[var(--brand-navy)] hover:text-white rounded-xl text-xs font-bold gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-2xl md:rounded-3xl overflow-hidden shadow-sm border border-slate-200 hover:-translate-y-2 hover:shadow-xl hover:border-[var(--brand-orange)]/40 transition-all duration-300 flex flex-col group">
              ...
              <div className="p-4 sm:p-6 flex-1 flex flex-col justify-between space-y-3">
                <span className="text-xs font-bold text-[var(--brand-orange)]">{t('travelGuide')}</span>
                <h3 className="font-black text-[var(--brand-navy)] text-base group-hover:text-[var(--brand-orange)] transition-colors">{t('travelGuideTitle')}</h3>
                <p className="text-xs text-slate-600 line-clamp-2">{t('travelGuideDescription')}</p>
                <Link href="/blog">
                  <span className="text-xs font-bold text-[var(--brand-navy)] flex items-center gap-1 pt-2 hover:underline">{t('readMore')} <ArrowRight className="w-3 h-3" /></span>
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl md:rounded-3xl overflow-hidden shadow-sm border border-slate-200 hover:-translate-y-2 hover:shadow-xl hover:border-[var(--brand-orange)]/40 transition-all duration-300 flex flex-col group">
              ...
              <div className="p-4 sm:p-6 flex-1 flex flex-col justify-between space-y-3">
                <span className="text-xs font-bold text-[var(--brand-orange)]">{t('realEstateInvestment')}</span>
                <h3 className="font-black text-[var(--brand-navy)] text-base group-hover:text-[var(--brand-orange)] transition-colors">{t('realEstateInvestmentTitle')}</h3>
            ...
            <div className="bg-white rounded-2xl md:rounded-3xl overflow-hidden shadow-sm border border-slate-200 hover:-translate-y-2 hover:shadow-xl hover:border-[var(--brand-orange)]/40 transition-all duration-300 flex flex-col group">
              ...
              <div className="p-4 sm:p-6 flex-1 flex flex-col justify-between space-y-3">
                <span className="text-xs font-bold text-[var(--brand-orange)]">{t('drivingTips')}</span>
                <h3 className="font-black text-[var(--brand-navy)] text-base group-hover:text-[var(--brand-orange)] transition-colors">{t('drivingTipsTitle')}</h3>
      ...
      <section className="py-10 md:py-16 bg-[var(--brand-navy)] text-white mt-0">
        <div className="container mx-auto max-w-6xl px-4 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 text-center">
          <div className="space-y-3">
            <div className="w-14 h-14 bg-[var(--brand-orange)] text-white rounded-2xl flex items-center justify-center mx-auto shadow-lg">
